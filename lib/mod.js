    ...
    if (this.element !== void 0) {
      ...
      for (let i7 = 0, name, value; i7 < attributes.length && ({ name, value } = attributes[i7]); i7++) {
        if (value === "") {
          ...
          yield ` ${name}="${(0, import_escape_html.escapeHtml)(value)}"`;
        }
      }
    }
  }
...
function* renderValue(value, renderInfo) {
  ...
  if (value != null && v2(value)) {
    ...
    if (value === void 0 || value === null || value === A || value === w) {
      ...
      yield (0, import_escape_html2.escapeHtml)(String(value));
    }
  }
  yield `<!--/lit-part-->`;
}
...
function* renderPropertyPart(instance, op, value) {
  ...
  if (reflectedName !== void 0) {
    yield `${reflectedName}="${(0, import_escape_html2.escapeHtml)(String(value))}"`;
  }
}
...
function* renderAttributePart(instance, op, value) {
  if (value !== A) {
    if (instance !== void 0) {
      ...
      yield `${op.name}="${(0, import_escape_html2.escapeHtml)(String(value ?? ""))}"`;
    }
  }
}
